...
/*    @Test
    public void test() {
        ...
        System.out.println(java.nio.file.Paths.get(System.getenv("APPDATA")).resolve(AUTHFILE_SUBPATH).toString());
    }*/
    ...
    private static boolean TryDecryptPassword(String encrypted, RefObject<String> decrypted) {
        decrypted.argValue = "";
        try {
            byte[] data = Base64.getDecoder().decode(encrypted);//Native.toByteArray(encrypted, StandardCharsets.UTF_8);
